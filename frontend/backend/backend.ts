...
export const getCheck: Backend['getCheck'] = async (request: Types.GetCheckRequest): Promise<Types.GetCheckResponses> => {
...
export const postExample: Backend['postExample'] = async (request: Types.PostExampleRequest): Promise<Types.PostExampleResponses> => {
